...
class EnumSys {
    constructor(req) {
        ...
        this.cacheSys = new CacheSys_1.CacheSys(req);
    }
    createEnumType() {
        return {
            n: {},
     ...
     * @param sPathEnumConf
     */
    async faSaveEnumType(sPathEnumConf) {
...
exports.EnumSys = EnumSys;
//# sourceMappingURL=EnumSys.js.map