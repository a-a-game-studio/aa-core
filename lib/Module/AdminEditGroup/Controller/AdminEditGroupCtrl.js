...
const AdminEditGroupM_1 = require("../Model/AdminEditGroupM");
const BaseCtrl_1 = require("../../../System/BaseCtrl");
const V = require("../Validator/AdminEditGroupV");
 ...
 */
router.post(V.selectCtrlAccess.route, async (req, res, next) => {
    const ctrl = new Ctrl(req, res);
    await ctrl.faInit();
 ...
 */
router.post(V.addCtrlAccessToGroup.route, async (req, res, next) => {
    const ctrl = new Ctrl(req, res);
    await ctrl.faInit();
 ...
 */
router.post(V.delCtrlAccessFromGroup.route, async (req, res, next) => {
    const ctrl = new Ctrl(req, res);
    await ctrl.faInit();
 ...
 * Добавить группу
 */
router.post(V.addGroup.route, async (req, res, next) => {
    const ctrl = new Ctrl(req, res);
    await ctrl.faInit();
 ...
 * Удалить группу
 */
router.post(V.delGroup.route, async (req, res, next) => {
    const ctrl = new Ctrl(req, res);
    await ctrl.faInit();
 ...
 * Сохранить группу
 */
router.post(V.saveGroup.route, async (req, res, next) => {
    const ctrl = new Ctrl(req, res);
    await ctrl.faInit();
 ...
 */
router.post(V.saveCtrlAccess.route, async (req, res, next) => {
    const ctrl = new Ctrl(req, res);
    await ctrl.faInit();
