 ...
 */
export class UserSys extends AAClasses.UserModule.User {
	...
	public constructor(req: MainRequest, listDB: AAClasses.SysteCoreModule.ListDB) {

		super(req.sys.errorSys, listDB)
