...
//  */
// router.post('/api/admin/user/add-group', async (req: System.MainRequest, res: any, next: any) => {
...
//     res.send(
//         self.responseSys.response(out, 'Добавленна группа')
//     );
// });
...
//  */
// router.post('/api/admin/user/del-group', async (req: System.MainRequest, res: any, next: any) => {
...
//     res.send(
//         self.responseSys.response(out, 'Удалить группу')
//     );
// });
